// Generated by V // will be removed later
...
bool is_js_prim(string typ) {
  ...
  return string_eq(typ, tos2("int")) || string_eq(typ, tos2("string")) ||
         string_eq(typ, tos2("bool")) || string_eq(typ, tos2("float")) ||
         string_eq(typ, tos2("f32")) || string_eq(typ, tos2("f64")) ||
...
V *new_v(array_string args) {
  ...
  if (os__file_exists(vroot_path)) {
    ...
    string vroot = string_trim_space(os__read_file(vroot_path));
  ...
  if (string_eq(lang_dir, tos2(""))) {
    ...
    if (os__dir_exists(_STR("%.*s/builtin", lang_dir.len, lang_dir.str))) {
      ...
      println(tos2("Please do it from \"v/compiler\" directory."));
